...
//   // Function to update the state with values from localStorage
//   const updateUI = () => {
//     setData({
//       petrolstock: localStorage.getItem('petrolstock') || 0,
//       petroldensity: localStorage.getItem('petroldensity') || 0,
//       petrolrate: localStorage.getItem('petrolrate') || 0,
//       dieselstock: localStorage.getItem('dieselstock') || 0,
//       dieseldensity: localStorage.getItem('dieseldensity') || 0,
//       dieselrate: localStorage.getItem('dieselrate') || 0,
//     });
//   };

//   useEffect(() => {
//     updateUI(); // Update UI on component mount
//     window.addEventListener('storage', updateUI); // Listen for storage events
//     return () => window.removeEventListener('storage', updateUI); // Cleanup listener
//   }, []);
...
const HomePage = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://127.0.0.1:8000/fuel-data'); // Update with your API URL
